...
const REMEDIATION: Record<string, string> = {
  ...
  "1.3.3": "Do not rely solely on shape, colour, position, or sound for instructions; add text labels.",
  ...
  "1.4.1": "Do not use colour as the only means of conveying information; pair colour with text, icons, or underlines.",
  ...
  "1.4.11": "Ensure non-text UI components have a contrast ratio of at least 3:1 against adjacent colours.",
