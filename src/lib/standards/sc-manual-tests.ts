const MANUAL_TESTS: Record<string, string> = {
  ...
  "1.3.3": "Confirm no instructions rely solely on shape, color, position, or sound.",
  ...
  "1.4.1": "Confirm color is not the only way information is conveyed (e.g. links are underlined, not just colored).",
  ...
  "1.4.8": "Confirm users can change foreground/background colors, line spacing, and text alignment.",
