...
const MACHINE: Record<string, string> = {
  ...
  "1.4.3": "color-contrast", "1.4.4": "meta-viewport", "1.4.6": "gap",
  ...
  "2.2.1": "meta-refresh", "2.2.2": "pause-stop-hide", "2.2.3": "gap",
  "2.4.1": "skip-link", "2.4.2": "document-title", "2.4.3": "tabindex",
  "2.4.5": "gap", "2.4.7": "focus-visible", "2.4.8": "gap", "2.4.10": "gap",
  "2.4.11": "gap", "2.4.12": "gap", "2.4.13": "gap",
  "2.5.1": "gap", "2.5.2": "pointer-cancellation", "2.5.3": "label-in-name",
  "2.5.4": "gap", "2.5.5": "gap", "2.5.7": "dragging-movements", "2.5.8": "target-size",
  "3.1.1": "html-has-lang", "3.1.2": "lang-of-parts",
  "3.2.1": "gap", "3.2.2": "gap", "3.2.3": "gap", "3.2.4": "gap", "3.2.6": "gap",
  "3.3.2": "label", "3.3.5": "gap", "3.3.7": "gap",
  "4.1.1": "duplicate-id", "4.1.3": "gap",
};
...
const AI: Record<string, AiModality> = {
  ...
  "2.3.3": "vision", "2.4.9": "vision",
  "3.1.3": "vision", "3.1.4": "vision", "3.1.5": "vision",
  "3.3.1": "vision", "3.3.3": "vision",
};

const MANUAL: string[] = [
  "1.2.8", "1.4.8", "2.1.3", "2.1.4", "2.2.4", "2.2.5", "2.2.6",
  "2.3.1", "2.3.2", "2.5.6", "3.1.6", "3.2.5", "3.3.4", "3.3.6", "3.3.8", "3.3.9",
];

const NOT_APPLICABLE: string[] = ["1.2.4", "1.2.9"];
