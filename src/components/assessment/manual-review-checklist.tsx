  ...
  return (
    <section aria-labelledby="manual-review-heading" className="mt-8">
      ...
      <p className="mt-1 font-sans text-sm text-terminal-muted">
        These success criteria cannot be verified automatically and require human judgement.
        Independent human review (coming soon) will resolve them and produce a signed conformance
        evaluation report.
      </p>
