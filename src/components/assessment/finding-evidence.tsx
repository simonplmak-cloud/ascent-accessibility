        ...
        <div className="mt-3 space-y-3">
          {instances.slice(0, 5).map((instance, i) => (
            <div key={i} className="rounded border border-terminal-border p-3">
              ...
              {instance.evidenceId && (
                // eslint-disable-next-line @next/next/no-img-element -- evidence images are served dynamically from the API (base64) and cannot be statically optimized by next/image
                <img
