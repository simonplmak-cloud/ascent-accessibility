...
import { aiResults, combinedSummary, humanReviewPending, machineResults } from "@/lib/report/report-methods";
...
const verdicts: AiVerdict[] = [
  ...
  { sc: "1.2.2", verdict: "CannotTell", confidence: 0.5, reasoning: "No media to judge." },
...
describe("combinedSummary", () => {
  it("returns the combined aggregates unchanged", () => {
    const c = {
      total: 4, passed: 1, failed: 1, notPresent: 1, cannotTell: 1,
